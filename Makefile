run_app:
	...
	find pages_files -exec sed -i.bak 's|_dash-component-suites|calcutta-model\\/_dash-component-suites|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-layout|calcutta-model/_dash-layout.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-dependencies|calcutta-model/_dash-dependencies.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_reload-hash|calcutta-model/_reload-hash|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-update-component|calcutta-model/_dash-update-component|g' {} \;
	find pages_files -exec sed -i.bak 's|assets|calcutta-model/assets|g' {} \;
